...
/* This was poorly generated by a script. Check parse_sections.php in the repo.
 * It's also not expected to change often.
 */
INSERT INTO fdzone(code, name, area) VALUES
	...
	('SD', 'South Dakota', '0'),
	('CT', 'Connecticut', '1'),
	('EMA', 'Eastern Massachusetts', '1'),
	('ME', 'Maine', '1'),
	('NH', 'New Hampshire', '1'),
	('RI', 'Rhode Island', '1'),
	('VT', 'Vermont', '1'),
	('WMA', 'Western Massachusetts', '1'),
	('ENY', 'Eastern New York', '2'),
	('NLI', 'New York City-Long Island', '2'),
	('NNJ', 'Northern New Jersey', '2'),
	('NNY', 'Northern New York', '2'),
	('SNJ', 'Southern New Jersey', '2'),
	('WNY', 'Western New York', '2'),
	('DE', 'Delaware', '3'),
	('EPA', 'Eastern Pennsylvania', '3'),
	('MDC', 'Maryland-DC', '3'),
	('WPA', 'Western Pennsylvania', '3'),
	('AL', 'Alabama', '4'),
	('GA', 'Georgia', '4'),
	('KY', 'Kentucky', '4'),
	('NC', 'North Carolina', '4'),
	('NFL', 'Northern Florida', '4'),
	('PR', 'Puerto Rico', '4'),
	('SC', 'South Carolina', '4'),
	('SFL', 'Southern Florida', '4'),
	('TN', 'Tennessee', '4'),
	('VA', 'Virginia', '4'),
	('VI', 'US Virgin Islands', '4'),
	('WCF', 'West Central Florida', '4'),
	('AR', 'Arkansas', '5'),
	('LA', 'Louisiana', '5'),
	('MS', 'Mississippi', '5'),
	('NM', 'New Mexico', '5'),
	...
	('PAC', 'Pacific', '6'),
	('SB', 'Santa Barbara', '6'),
	('SCV', 'Santa Clara Valley', '6'),
	('SDG', 'San Diego', '6'),
	('SF', 'San Francisco', '6'),
	('SJV', 'San Joaquin Valley', '6'),
	('SV', 'Sacramento Valley', '6'),
	('AK', 'Alaska', '7'),
	('AZ', 'Arizona', '7'),
	('EWA', 'Eastern Washington', '7'),
	('ID', 'Idaho', '7'),
	('MT', 'Montana', '7'),
	('NV', 'Nevada', '7'),
	('OR', 'Oregon', '7'),
	('UT', 'Utah', '7'),
	('WWA', 'Western Washington', '7'),
	('WY', 'Wyoming', '7'),
	('MI', 'Michigan', '8'),
	('OH', 'Ohio', '8'),
	('WV', 'West Virginia', '8'),
	...
	('GH', 'Ontario Golden Horseshoe', 'C'),
	('MB', 'Manitoba', 'C'),
	('NB', 'New Brunswick', 'C'),
	('NL', 'Newfoundland and Labrador', 'C'),
	('NS', 'Nova Scotia', 'C'),
	('ONE', 'Ontario East', 'C'),
	('ONN', 'Ontario North', 'C'),
	('ONS', 'Ontario South', 'C'),
...
CREATE TABLE fdband (
	...
	cabfreq CHAR(5) NOT NULL,
	PRIMARY KEY pk_fdband(code)
) ENGINE=InnoDB;
INSERT INTO fdband VALUES
	("160m",  1800000,    2000000,    '1800'),
	("80m",   3500000,    4000000,    '3500'),
	("40m",   7000000,    7300000,    '7000'),
	("20m",   14000000,   14350000,   '14000'),
	("15m",   21000000,   21450000,   '21000'),
	("10m",   28000000,   29700000,   '28000'),
	("6m",    50000000,   54000000,   '50'),
	("2m",    144000000,  148000000,  '144'),
	("1.25m", 222000000,  224000000,  '222'),
	("70cm",  420000000,  450000000,  '432'),
	("33cm",  902000000,  928000000,  '902'),
	("13cm",  2390000000, 2450000000, '2.3G'),
	("none",  0,          0,          'XXX');
